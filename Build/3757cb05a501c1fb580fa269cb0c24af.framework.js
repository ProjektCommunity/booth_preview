...
var ASM_CONSTS = {
  3418592: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 3418653: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 3418717: function() {return Module.webglContextAttributes.powerPreference;},  
 3418775: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 3418830: function($0) {performance.now = function() { return $0; };},  
 3418878: function($0) {performance.now = function() { return $0; };},  
 3418926: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _ImageUploaderInit() {
          var buttonUploaderTop = document.getElementById("topBannerButton")
          var fileInputTop = document.createElement('input');
          fileInputTop.setAttribute('type', 'file');
          fileInputTop.onclick = function (event) {
            this.value = null;
          };
          fileInputTop.onchange = function (event) {
            SendMessage('Canvas', 'FileSelectedTopBanner', URL.createObjectURL(event.target.files[0]));
          }
          buttonUploaderTop.appendChild(fileInputTop);
  
          var buttonUploaderNeonGradient = document.getElementById("neonGradientButton")
          var fileInputNeonGradient = document.createElement('input');
          fileInputNeonGradient.setAttribute('type', 'file');
          fileInputNeonGradient.onclick = function (event) {
            this.value = null;
          };
          fileInputNeonGradient.onchange = function (event) {
            SendMessage('Canvas', 'FileSelectedNeonGradient', URL.createObjectURL(event.target.files[0]));
          }
          buttonUploaderNeonGradient.appendChild(fileInputNeonGradient);
  
          var buttonUploaderLeftPoster = document.getElementById("leftPosterButton")
          var fileInputLeftPoster = document.createElement('input');
          fileInputLeftPoster.setAttribute('type', 'file');
          fileInputLeftPoster.onclick = function (event) {
            this.value = null;
          };
          fileInputLeftPoster.onchange = function (event) {
            SendMessage('Canvas', 'FileSelectedLeftPoster', URL.createObjectURL(event.target.files[0]));
          }
          buttonUploaderLeftPoster.appendChild(fileInputLeftPoster);
  
          var buttonUploaderRightPoster = document.getElementById("rightPosterButton")
          var fileInputRightPoster = document.createElement('input');
          fileInputRightPoster.setAttribute('type', 'file');
          fileInputRightPoster.onclick = function (event) {
            this.value = null;
          };
          fileInputRightPoster.onchange = function (event) {
            SendMessage('Canvas', 'FileSelectedRightPoster', URL.createObjectURL(event.target.files[0]));
          }
          buttonUploaderRightPoster.appendChild(fileInputRightPoster);
  
          var buttonUploaderDeskPoster = document.getElementById("deskPosterButton")
          var fileInputDeskPoster = document.createElement('input');
          fileInputDeskPoster.setAttribute('type', 'file');
          fileInputDeskPoster.onclick = function (event) {
            this.value = null;
          };
          fileInputDeskPoster.onchange = function (event) {
            SendMessage('Canvas', 'FileSelectedDeskPoster', URL.createObjectURL(event.target.files[0]));
          }
          buttonUploaderDeskPoster.appendChild(fileInputDeskPoster);
  
          var buttonUploaderLCDDisplay = document.getElementById("lcdDisplayPoster")
          var fileInputLCDDisplay = document.createElement('input');
          fileInputLCDDisplay.setAttribute('type', 'file');
          fileInputLCDDisplay.onclick = function (event) {
            this.value = null;
          };
          fileInputLCDDisplay.onchange = function (event) {
            SendMessage('Canvas', 'FileSelectedLCDDisplay', URL.createObjectURL(event.target.files[0]));
            console.log(event.target.files[0]);
          }
          buttonUploaderLCDDisplay.appendChild(fileInputLCDDisplay);
  ...
  function _firebaseLogin(email, password) {
          // Ask script to login to firebase
          window.signInFirebase(Pointer_stringify(email), Pointer_stringify(password));
          console.log("Hi from ImageUploaderPlugin.jslib, the email is: " + Pointer_stringify(email) + " and the password is: " + Pointer_stringify(password));
        }
